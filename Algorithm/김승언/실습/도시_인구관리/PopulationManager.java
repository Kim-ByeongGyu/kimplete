...
public class PopulationManager {
    ...
    public void addOrUpdateCity(String city, int population) {
        ...
        System.out.println(city + "의 인구 정보가 추가/수정되었습니다.");
    }
    ...
    public void removeCity(String city) {
        if (populationMap.containsKey(city)) {
            ...
            System.out.println("해당하는 도시의 인구 정보가 존재하지 않습니다.");
        }
    }

    // 특정 도시의 인구 조회
    public void displayPopulation(String city) {
        Integer population = populationMap.get(city);
        if (population != null) {
            System.out.println(city + "의 인구는 " + population + "명 입니다.");
        } else {
            System.out.println("해당하는 도시의 인구 정보가 존재하지 않습니다.");
        }
    }
    ...
    public void displayAll() {
        if (populationMap.isEmpty()) {
            System.out.println("등록된 도시 인구 정보가 없습니다.");
        } else {
            System.out.println("전체 도시 인구 정보:");
